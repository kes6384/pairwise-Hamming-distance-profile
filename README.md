...
Compile matrixV2_OMP with command: g++ -O3 -fPIC -fopenmp -std=c++20 -pipe -D_FILE_OFFSET_BITS=64 -o matrix2OMP matrixV2_OMP.cpp -I .\eigen-5.0.0  
...
To run matrix2OMP: matrix2OMP [FASTA FILE].fna [sequence length] [k] [numThreads]  
